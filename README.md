...
[![Deploy to Netlify](https://www.netlify.com/img/deploy/button.svg)](https://app.netlify.com/start/deploy?repository=https://github.com/larsj/nextjs-netlify-blog-template&stack=cms)
...
```
npx create-next-app your-blog --example "https://github.com/larsj/nextjs-netlify-blog-template"
```
